...
const Home = () => {
  ...
  return (
   ...
   <Card className='border-black mx-auto sm:w-[600px] sm:h-[600px] border-4 '>
    ...
    <div className="p-3">
        <a href="#">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-black dark:text-white">Know Your Interest !</h5>
        </a>
        <p className="mb-3  font-semibold text-black dark:text-gray-400">Here is your learning pathway Quiz. Be Specific about your interests and likings. Decide today and Skill Up !</p>
        <Button onClick={handleTakeQuizClick} gradientDuoTone="cyanToBlue" outline>
            Take Quiz
          </Button>
    </div>
...
<section class="bg-white dark:bg-gray-900">
    <div class=" px-4 py-6 lg:py-6 mx-auto max-w-screen-md text-center  lg:px-12">

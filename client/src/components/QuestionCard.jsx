                    ...
                    <div className='px-4' action=''>
                        ...
                        {question.answerOptions.map((answerOption) => (
                            ...
                            className={
                                ...
                                : 'w-full text-left font-thin text-gray-900 hover:text-white border-[1.5px] border-blue-700  hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-md text-base px-5 py-2.5 mr-2 mb-2 dark:border-gray-600 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800'
                            }
                            >
